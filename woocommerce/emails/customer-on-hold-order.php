...
<p><?php printf(esc_html__( 'Ti comunichiamo che %s per essere ritirata presso il nostro store in Largo P. B.Shelley, 20, 56017 San Giuliano Terme PI indicativamente dal: %s. Riceverai un’email di conferma appena potrai venire a ritirarla.', 'montepisanotree' ),$targhet_number, $delivery_date); ?></p>
