...
?>
<p><?php printf( esc_html__( 'Hi %s,', 'woocommerce' ), esc_html( $order->get_billing_first_name() ) ); ?></p>
<p><?php printf(esc_html__( 'Ti informiamo che %s tutti i giorni dal lunedì al venerdì dalle ore 10:00 alle 19:00 ed il sabato dalle 10 alle 13 presso il nostro Store in Largo P. B.Shelley, 20, 56017 San Giuliano Terme PI. Grazie ancora', 'montepisanotree' ),$targhet_number); ?></p>
<?php endif; ?>
